...
import numpy as np
#from ActorNetwork_0130 import ActorNetwork
...
def drive_example(c):
    ...
    # Steer To Center
    R['steer']-= (S['trackPos']+delta)*.30
    """

    lateralSetPoint = delta
    pLateralOffset = -0.3
    pAngleOffset = 1
    R['steer'] = -pLateralOffset *(S['trackPos'] + lateralSetPoint)- pAngleOffset *S['trackPos']
    """
    # Throttle Control
    '''
...
def my50light(c):
    ...
    actor.model.load_weights("/home/tian/gym_torcs/actormodel.h5")
    S_3 = []
    S,R= c.S.d,c.R.d
    for n in S['wheelSpinVel']:
        n = n/100.0
    alist = ['angle','track','trackPos','speedX','speedY','speedZ','wheelSpinVel','rpm']
