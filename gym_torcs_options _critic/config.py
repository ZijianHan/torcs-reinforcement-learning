...
parser.add_argument('--option_size', help='Number of options', type=int, default=3)
parser.add_argument('--nepisodes', help="Number of episodes per run", type=int, default=1000)
parser.add_argument('--nsteps', help="Maximum number of steps per episode", type=int, default=800)
...
parser.add_argument('--epsilon_decay', help="Decay on randomness", type=float, default=0.9995)
