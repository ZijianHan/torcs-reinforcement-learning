    ...
    for i_episode in range(MAX_EPISODE):
        ...
        for step in range(MAX_EP_STEPS):
            ...
            for i in range(step_time[option]):
                ...
                if r_t_primitive == -5.0 or r_t_primitive == -1.0:
                    damage_times += 1
        ...
        if train_indicator:
            ...
            sio.savemat('results.mat',{'total_reward':cumreward_list,'average_reward':average_step_reward_list,'epsilon':epsilon_list,'damage_rate':damage_rate_list})
        else:
            sio.savemat('info.mat',{'ep_reward':epreward_list,'option':option_list,'trackPos':trackPos_list,'speed':speed_list})
